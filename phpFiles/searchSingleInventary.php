<?php
 ...
 FROM inventary inv LEFT JOIN items i ON inv.item_number=i.id LEFT JOIN devices d ON d.id=i.printer_model 
where d.device like '%$param%' or i.item_number like '%$param%'
 or i.item_desc like '%$param%' or inv.statut like '%$param%' order by cod desc";
