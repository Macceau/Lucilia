...
<head>
  ...
  <title>LuciliaFinder / Locator</title>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <h3 class="card-title">Create a New Locator</h3>
                <!-- Vertical Form -->
              <form class="row g-3" id="newlocator">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Locator</label>
                  <input type="text" class="form-control" name="locatorname" id="locatorname">
                  <input type="text" class="form-control" name="idlocatorname" id="idlocatorname" hidden>
                </div>
                <div class="text-center">
                  <button type="submit" id="InsertLocator" class="btn btn-primary">Create</button>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <h3 class="card-title">Locator Table Listed</h3>
