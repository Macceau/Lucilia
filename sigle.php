    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <h3 class="card-title">Create an UOM</h3>
                <!-- Vertical Form -->
              <form class="row g-3" id="newsigle">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">UOM</label>
                  <input type="text" class="form-control" name="siglename" id="siglename">
                  <input type="text" class="form-control" name="idsiglename" id="idsiglename" hidden>
                </div>
                <div class="text-center">
                  <button type="submit" id="Insertsigle" class="btn btn-primary">Create</button>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <h3 class="card-title">UOM Table Listed</h3>
